...
try {
    // Get all completed orders assigned to this rider in this business window where online payment was collected
    $stmt = $pdo->prepare("
        SELECT o.id, o.status, o.delivered_at, o.paid_amount_online, o.paid_amount_cash,
               u.name as user_name,
    ...
    <div style="padding: 10px;">
        <?php if (empty($orders)): ?>
            <div style="text-align: center; padding: 40px 20px; color: #64748b;">
                ...
                <div style="font-weight: 700; font-size: 1.1rem; color: #1e293b;">No online collections found</div>
            </div>
        <?php else: ?>
                ...
                <?php foreach ($orders as $order): ?>
                    <div style="background: white; border: 1.5px solid #f1f5f9; border-radius: 20px; padding: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.03);">
                        <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 12px;">
                            <div>
                                <div style="font-size: 0.7rem; font-weight: 800; color: #4f46e5; margin-bottom: 4px; letter-spacing: 0.02em;">
                                    #ORD-<?php echo str_pad($order['id'], 5, '0', STR_PAD_LEFT); ?>
                                    <?php if ($order['paid_amount_cash'] > 0): ?>
                            ...
                            <div style="text-align: right;">
                                ...
                                <span style="font-size: 1.3rem; font-weight: 900; color: #4f46e5;"><?php echo number_format($order['paid_amount_online']); ?></span>
                            </div>
                        </div>
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: flex-end;">
                            <div style="font-size: 0.8rem; font-weight: 600; color: #64748b;">
                                ...
                                <div style="font-size:0.65rem; color:#94a3b8; margin-top:4px; font-weight: 700;">Collected via Online Payment</div>
                            </div>
                            <div style="display: flex; flex-direction: column; gap: 8px; align-items: flex-end;">
                                <span style="background:#eef2ff; color:#4f46e5; padding: 4px 10px; border-radius: 8px; font-size: 0.65rem; font-weight: 800; text-transform: uppercase; border: 1px solid #4f46e520;">
                                    ONLINE PAID
                                </span>
