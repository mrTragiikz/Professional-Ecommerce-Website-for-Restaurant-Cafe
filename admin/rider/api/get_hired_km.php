...
try {
    // Get all completed orders assigned to this rider in this business window where delivery distance exists
    $stmt = $pdo->prepare("
        ...
        WHERE o.rider_id = ? AND o.status IN ('completed', 'received') AND o.delivery_distance_km > 0 AND (o.delivered_at >= ? AND o.delivered_at <= ?)
    ...
    <div style="padding: 10px;">
        <?php if (empty($orders)): ?>
            <div style="text-align: center; padding: 40px 20px; color: #64748b;">
                ...
                <div style="font-weight: 700; font-size: 1.1rem; color: #1e293b;">No hired KM found</div>
            </div>
        <?php else: ?>
                ...
                <?php foreach ($orders as $order): ?>
                    <div style="background: white; border: 1.5px solid #f1f5f9; border-radius: 20px; padding: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.03);">
                        <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 12px;">
                            <div>
                                <div style="font-size: 0.7rem; font-weight: 800; color: #f59e0b; margin-bottom: 4px; letter-spacing: 0.02em;">
                            ...
                            <div style="text-align: right;">
                                <span style="font-size: 1.3rem; font-weight: 900; color: #f59e0b;"><?php echo number_format($order['delivery_distance_km'], 2); ?></span>
                                <span style="font-size: 0.75rem; font-weight: 700; color: #94a3b8; margin-left: 2px;">km</span>
                            </div>
                        </div>
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: flex-end;">
                            <div style="font-size: 0.8rem; font-weight: 600; color: #64748b;">
                                ...
                                <div style="font-size:0.65rem; color:#94a3b8; margin-top:4px; font-weight: 700;">Delivery Distance Tracked</div>
                            </div>
                            <div style="display: flex; flex-direction: column; gap: 8px; align-items: flex-end;">
                                <span style="background:#fffbeb; color:#f59e0b; padding: 4px 10px; border-radius: 8px; font-size: 0.65rem; font-weight: 800; text-transform: uppercase; border: 1px solid #f59e0b20;">
                                    KILOMETERS
                                </span>
